...
<h4><?php echo isset($al_options['al_bxtitle']) ? $al_options['al_bxtitle'] : '' ?></h4>
<h6>- <?php echo get_post_meta($post->ID, 'heading_2', true); ?> -</h6>
...
<div class="bxwrap1">
<ul id="bxslider1">
<?php 				$args = array( 'post_type' => 'specialslide');
				$posts = get_posts( $args );
				foreach ( $posts as $post ) {
				$large=wp_get_attachment_url(get_post_thumbnail_id($post->ID));
?>
<li> 
<img src="<?php echo $large; ?>" alt=""/> 
<div class="pricebg"><p> <?php echo get_post_meta($post->ID, 'price', true); ?></p></div>
<p>
<?php echo $post->post_content;?>
</p>
