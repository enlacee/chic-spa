...
function new_meta_boxes( $type ) {
    ...
    echo '<input type="hidden" name="Lotus_meta_box_nonce" value="', wp_create_nonce(basename(__FILE__)), '" />';
...
function create_meta_box() {
	...
	if ( function_exists('add_meta_box') ) {
		add_meta_box( 'new_meta_boxes_page', 'Lotus'  . ' Page Settings', 'new_meta_boxes_page', 'page', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_post', 'Lotus'  . ' Post Settings', 'new_meta_boxes_post', 'post', 'normal', 'high' );
		add_meta_box( 'new_meta_boxes_portfolio', 'Lotus'  . ' Portfolio Settings', 'new_meta_boxes_portfolio', 'portfolio', 'normal', 'high' );
	}
}

function save_postdata( $post_id ) {
	
	if ( !wp_verify_nonce(isset($_POST['Lotus_meta_box_nonce']) ? $_POST['Lotus_meta_box_nonce'] : '', basename(__FILE__)) ) {
