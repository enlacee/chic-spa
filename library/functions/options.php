...
$options = array(
	...
	array(
		...
		array(
		'name' => 'Breadecumb image',
		'id' => $shortname . '_breadecumb',
		'type' => 'upload',
		'img_w' => '180',
		'img_h' => '145',
		'std' => '',
		'desc' => 'Upload a logo from your hard drive or specify an existing url (Recommended size: 180x145)'
	),
		array(
		'name' => 'Breadecumb image2',
		'id' => $shortname . '_breadecumb2',
		'type' => 'upload',
		'img_w' => '180',
		'img_h' => '145',
		'std' => '',
		...
		array(
		'name' => 'Breadecumb image3',
		'id' => $shortname . '_breadecumb3',
		'type' => 'upload',
		'img_w' => '180',
		'img_h' => '145',
		'std' => '',
		...
		array(
		'name' => 'Home Paralax underslide text',
		'id' => $shortname . '_underslidetext',
		'type' => 'text',
		'std' => '',
		'desc' => 'Home Paralax underslide text.'
	) ,
	
		array(
		'name' => 'Home Camera underslide text',
		'id' => $shortname . '_cunderslidetext',
		'type' => 'text',
		'std' => '',
		'desc' => 'Home Camera underslide text.'
	) ,
	...
	array(
		'name' => 'Header Right Site Phone Number',
		'id' => $shortname . '_phonenumber',
		'type' => 'text',
		'std' => '',
		'desc' => 'Header Right Site Phone Number.'
	) ,
		array(
		'name' => 'Website Title',
		'id' => $shortname . '_title',
	...
	array(
		...
		'type' => 'textarea',
		'std' => '',
		'desc' => 'Please go to https://maps.google.com/ and set your address, fixed height and width tnen copy the embed code and paste here. '
	) ,
	...
	array(
		'name' => 'Home Paralax Bx Slider Title',
		'id' => $shortname . '_bxtitle',
		'type' => 'text',
		'std' => '',
		'desc' => 'Home Paralax Bx slider Title.'
	) ,
	
	array(
		'name' => 'Home Paralax And Camera Tab Title',
		'id' => $shortname . '_tabtitle',
		'type' => 'text',
		'std' => '',
		'desc' => 'Home Paralax And Camera Tab Title.'
	) ,
	
	array(
		'name' => 'Home Paralax And Camera Recent News Title',
		'id' => $shortname . '_newstitle',
		'type' => 'text',
		'std' => '',
		'desc' => 'Home Paralax And Camera Recent News Title.'
	) ,
