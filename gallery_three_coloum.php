<?php get_header();
/**
 * Template Name: Gellary_three_coloum
 */
?>
...
<ul id="list" class="image-grid row gallery2">
    <?php
	$image="";
    query_posts(array(
        'post_type' => 'portfolio',
...
<li data-id="id-<?php echo $post->ID; ?>" class="everybody feature1 span4  <?php foreach ($portfolio_types as $item) echo $item->slug . ' '; ?>"><!-- one picture-->
...
<div class="mask">
<a href="<?php echo $image; ?>" class="prettyPhoto[pp_gal]" title="<?php the_title();?>"></a>
<h2><?php the_title();?></h2>
